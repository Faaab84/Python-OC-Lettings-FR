...
This page lists all technologies, frameworks, and tools used in the project.
...
- **Sentry**: Error tracking and monitoring
  ...
  - ``send_default_pii=True``: User context capture
  - ``enable_logs=True``: Application logs integration
